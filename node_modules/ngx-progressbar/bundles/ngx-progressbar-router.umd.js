(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('ngx-progressbar'),require('@angular/router'),exports, require('@angular/core'), require('@angular/router'), require('rxjs'), require('rxjs/operators'), require('ngx-progressbar')) :
    typeof define === 'function' && define.amd ? define('ngx-progressbar/router', ['@angular/core','ngx-progressbar','@angular/router','exports', '@angular/core', '@angular/router', 'rxjs', 'rxjs/operators', 'ngx-progressbar'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ngxProgressbar,global.ng.router,(global['ngx-progressbar'] = global['ngx-progressbar'] || {}, global['ngx-progressbar'].router = {}), global.ng.core, global.ng.router, global.rxjs, global.rxjs.operators, global['ngx-progressbar']));
