...
import { VehicleTypeM, VehicleType, VehicleByTypeM, VehicleByType, VehicleCategoryM, VehicleCategory, EngineStrokeM, EngineStroke } from '@netzero/model/vehicle.model';
