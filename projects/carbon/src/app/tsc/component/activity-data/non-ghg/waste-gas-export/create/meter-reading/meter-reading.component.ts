...
export class MeterReadingComponent implements OnInit {
    ...
    ngOnChanges(changes: SimpleChanges) {
        if (changes.activityDataFG.firstChange && this.action == 'create') {
            this.formDataInit();
        }
    ...
    patchMeterUnit() {
        this.activityDataFA.get('meterUnitID').patchValue(this.activityConfig['activityConfigData']['meterRollover']['unitID']);
    }

    formDataInit() {
        console.log(this.activityConfig['activityConfigData']['meterRollover']['unit']['unitID']);
        this.activityDataFA.push(
            this.formBuilder.group({
                ...
                meterUnitID: [this.activityConfig['activityConfigData']['meterRollover']['unit']['unitID']],
                docID: [],
                docType: [],
                docName: [],
                docPath: [],
    ...
    dateInpChange(formGroup: FormGroup, index) {
        if (this.customDateInputs) {
            let customDateInputInstance = this.customDateInputs.toArray()[index];
            let startDate;
            let endDate;
