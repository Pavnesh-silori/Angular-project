...
export class CarbonPricePageComponent implements OnInit {
    ...
    displayedColumns: string[] = ['recordID', 'reportingPeriod', 'coveredEmissions', 'dueCarbonPrice', 'amountOfRebate', 'document', 'option'];
