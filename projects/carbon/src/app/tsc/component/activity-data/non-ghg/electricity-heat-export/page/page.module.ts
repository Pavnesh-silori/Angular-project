...
import { ElectricityHeatExportPageRoutingModule } from './page-routing.module';
...
@NgModule({
    declarations: [
        ElectricityHeatExportPageComponent
    ],
    imports: [
        CommonModule,
        ElectricityHeatExportPageRoutingModule,
        FontAwesomeModule,
        MatButtonModule,
        DateFilterModule,
        NgbModule,
...
export class ElectricityHeatExportPageModule { }
