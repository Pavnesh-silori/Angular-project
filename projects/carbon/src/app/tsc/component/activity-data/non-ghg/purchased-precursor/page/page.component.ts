...
import { PurchasedPrecursor, PurchasedPrecursorM } from '@carbon/model/non-ghg.model';
...
export class PageComponent implements OnInit {
    ...
    dataSource: PurchasedPrecursorM[] = [new PurchasedPrecursor()];
    selectedRows: PurchasedPrecursorM[] = [];
    ...
    searchByPlaceHolder: string = 'precursor name';
    ...
    displayedColumns: string[] = ['recordID', 'reportingPeriod', 'supplier', 'precursor', 'embeddedEmissions', 'dueCarbonPrice', 'document', 'option'];
    ...
    ngAfterViewInit() {
        ...
        merge(
            ...
            switchMap(() => {
                ...
                if (this.searchFlag) {
                    searchValue = ('precursor:' + this.searchValue);
                }
