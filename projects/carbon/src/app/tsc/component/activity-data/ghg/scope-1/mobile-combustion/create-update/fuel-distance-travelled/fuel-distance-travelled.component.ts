...
@Component({
    ...
    styleUrls: ['./fuel-distance-travelled.component.scss']
})
...
export class FuelDistanceTravelledComponent {
    ...
    //TODO: optimize it before final push
    addValidators(formGroup) {
        ...
        if (fuelAmount != null && fuelAmount != undefined && distanceTravelled != null && distanceTravelled != undefined) {
        ...
        } else if (fuelAmount != null && fuelAmount != undefined && mileage != null && mileage != undefined) {
            formGroup.get('distanceTravelled').clearValidators();
            formGroup.get('distanceTravelledUnitID').clearValidators();
        } else if (distanceTravelled != null && distanceTravelled != undefined && mileage != null && mileage != undefined) {
