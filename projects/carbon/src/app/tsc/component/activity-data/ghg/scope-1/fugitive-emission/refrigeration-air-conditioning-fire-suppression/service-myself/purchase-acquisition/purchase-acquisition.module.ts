...
import { PurchaseAcquisitionRoutingModule } from './purchase-acquisition-routing.module';
...
@NgModule({
	declarations: [
		PurchaseAcquisitionComponent
	],
	imports: [
		CommonModule,
		PurchaseAcquisitionRoutingModule,
		FontAwesomeModule,
        MessageAlertModule,
        DateFilterModule,
		MatButtonModule,
...
export class PurchaseAcquisitionModule { }
