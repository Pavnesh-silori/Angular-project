...
export class PriceOdometerReadingComponent implements OnInit {
    ...
    formFields: any[] = [
        'dateRange', 'fuelTypeID', 'billAmount', 'billCurrencyID', 'fuelRate',
        'fuelRateNumeratorUnitID', 'fuelRateDenominatorUnitID', 'openingOdometerReading',
        'closingOdometerReading', 'odometerReadingUnitID', 'mileage',
    ...
    addValidators(formGroup) {
        ...
        const minFields = ['billAmount', 'fuelRate', 'openingOdometerReading', 'closingOdometerReading', 'mileage'];
        ...
        if (fuelRate != null && openingOdometer != null && closingOdometer != null) {
        ...
        } else if (billAmount != null && fuelRate != null && openingOdometer != null && closingOdometer != null) {
