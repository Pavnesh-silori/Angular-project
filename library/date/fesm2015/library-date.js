...
import { COMMON_CONSTANT, MaterialFormFieldAppearance } from '@library/tsc-common';
    ...
    patchDefaultConfig() {
        if (this.dateInputType == this.dateInputTypeEnum.DAY_INPUT) {
            if (this.showDefaultDuration) {
                ...
                this.endDateFC.patchValue(moment$1().tz(this.timezone).format());
            }
        }
