(function (global, factory) {
    ...
    var DATE_CONSTANT = {
        TODAY_YYYY_MM_DD: moment__namespace(new Date()).format("YYYY-MM-DD"),
        CURRENT_YEAR: new Date().getFullYear(),
        MAX_DATE: new Date('9999-12-31'),
        MAX_DATE_YYYY_MM_DD: moment__namespace(new Date('9999-12-31')).format("YYYY-MM-DD"),
        MAX_DATE_YYYY_MMM_DD: moment__namespace(new Date('9999-12-31')).format("YYYY-MMM-DD"),
    ...
    ***************************************************************************** */
    ...
    var DateService = /** @class */ (function () {
        ...
        DateService.prototype.takeFocusAway = function (duration) {
            var fieldElement = document.getElementById(duration);
            if (fieldElement) {
        ...
        DateService.prototype.getRelativeTimeAgoLabel = function (dateTime, timezone) {
    ...
    var DateInputComponent = /** @class */ (function () {
        function DateInputComponent(dateService) {
            ...
            this.formErrorEnum = tscCommon.FormErrorEnum;
            ...
            if (this.dateInputType == this.dateInputTypeEnum.DAY_INPUT) {
                if (this.showDefaultDuration) {
                    ...
                    var endDateValue = this.dateType == this.dateTypeEnum.INCLUSIVE
                        ? moment__namespace$1().tz(this.timezone).format()
                        : moment__namespace$1().add(1, 'days').startOf('day').tz(this.timezone).format();
    ...
    exports.DATE_CONSTANT = DATE_CONSTANT;
