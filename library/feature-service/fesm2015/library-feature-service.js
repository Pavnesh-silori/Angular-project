...
const ENERGY_FEATURE_CONSTANT = {
    ...
    DATA_AVAILABILITY_REPORT: [[ApplicationKeyID.ENERGY_KEY_ID], 'BY_DEFAULT_FEATURE'],
    ENERGY_USAGE_REPORT: [[ApplicationKeyID.ENERGY_KEY_ID], 'BY_DEFAULT_FEATURE'],
    ENERGY_USAGE_BY_FACILITY_REPORT: [[ApplicationKeyID.ENERGY_KEY_ID], 'BY_DEFAULT_FEATURE'],
    ENERGY_USAGE_BY_SOURCE_REPORT: [[ApplicationKeyID.ENERGY_KEY_ID], 'BY_DEFAULT_FEATURE'],
    ENERGY_USAGE_BY_LOAD_REPORT: [[ApplicationKeyID.ENERGY_KEY_ID], 'BY_DEFAULT_FEATURE'],
    ...
    LAYOUT_VIEW: [[ApplicationKeyID.ENERGY_KEY_ID], 'BY_DEFAULT_FEATURE'],
    LAYOUT_ENTITY_TREE_VIEW: [[ApplicationKeyID.ENERGY_KEY_ID], 'BY_DEFAULT_FEATURE'],
...
const WATER_FEATURE_CONSTANT = {
    ...
    CONSUMPTION_BREAKUP_REPORT: [[ApplicationKeyID.WATER_KEY_ID], 'BY_DEFAULT_FEATURE'],
    USAGE_ACROSS_FACILITY_REPORT: [[ApplicationKeyID.WATER_KEY_ID], 'BY_DEFAULT_FEATURE'],
    WATER_METER_REPORT: [[ApplicationKeyID.WATER_KEY_ID], 'BY_DEFAULT_FEATURE'],
    DERIVED_PARAMETER_REPORT: [[ApplicationKeyID.WATER_KEY_ID], 'BY_DEFAULT_FEATURE'],
    ...
    LAYOUT_VIEW: [[ApplicationKeyID.WATER_KEY_ID], 'BY_DEFAULT_FEATURE'],
    LAYOUT_ENTITY_TREE_VIEW: [[ApplicationKeyID.WATER_KEY_ID], 'BY_DEFAULT_FEATURE'],
    //BUDGETING AND PLANNING: Setting Sidebar
...
export { ADMIN_FEATURE_CONSTANT, ApplicationFeature, CARBON_FEATURE_CONSTANT, CONNECT_FEATURE_CONSTANT, ENERGY_FEATURE_CONSTANT, FeatureDirective, FeatureDirective2, FeatureDirectiveModule, FeatureDirectiveModule2, FeatureGuard, FeatureJson, FeatureService, FeatureServiceComponent, FeatureServiceModule, FeatureServiceService, IsFeatureAvailable, WATER_FEATURE_CONSTANT };
