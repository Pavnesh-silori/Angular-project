(function (global, factory) {
    ...
    var UserController = /** @class */ (function () {
        ...
        UserController.prototype.getUserListByOrgIDAndAppID = function (orgID, applicationID) {
    ...
    ***************************************************************************** */
    ...
    var UserService = /** @class */ (function () {
        ...
        UserService.prototype.getUserListByOrgIDAndAppID = function (orgID, appID) {
            return __awaiter(this, void 0, void 0, function () {
                var orgUserM, error_4;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.userController.getUserListByOrgIDAndAppID(orgID, appID).toPromise()];
                        case 1:
                            orgUserM = _a.sent();
                            if (orgUserM) {
                                return [2 /*return*/, orgUserM];
