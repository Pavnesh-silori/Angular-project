...
export declare class SearchBarOneComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SearchBarOneComponent, "lib-search-bar-one", never, { "type": "type"; "searchBy": "searchBy"; "clear": "clear"; }, { "emitSearch": "emitSearch"; }, never, never>;
}
