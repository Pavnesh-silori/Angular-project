...
export declare enum ImageDefaultPathEnum {
    USER_PROFILE = "/assets/images/default-img.jpeg",
    ORG_LOGO = "/assets/images/default-img.jpeg",
    FACILITY_LOGO = "/assets/images/default-img.jpeg"
}
export declare enum ImageErrorEnum {
