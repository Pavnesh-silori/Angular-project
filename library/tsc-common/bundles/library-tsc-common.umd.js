(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@angular/common'), require('rxjs/operators'), require('@angular/material/progress-spinner'), require('@angular/common/http'), require('@angular/router'), require('@library/storage-service'), require('@library/toastr-service'), require('@library/application-service'), require('@library/authentication-service'), require('@angular/forms'), require('@library/user-service'), require('@angular/platform-browser'), require('@angular/material/icon'), require('@angular/material/tooltip'), require('@ng-bootstrap/ng-bootstrap'), require('ngx-perfect-scrollbar'), require('@angular-redux/store'), require('@library/feature-service'), require('@library/rbac-service'), require('@angular/material/button-toggle'), require('@library/layout-service'), require('@angular/material/card'), require('@library/organization-service'), require('@library/facility-service'), require('@fortawesome/free-solid-svg-icons'), require('@fortawesome/angular-fontawesome'), require('@angular/material/core'), require('@angular/material/input'), require('@angular/material/form-field'), require('@ngx-loading-bar/router'), require('@angular/animations'), require('@ngx-loading-bar/core'), require('@fortawesome/free-solid-svg-icons/faArrowAltCircleLeft'), require('@angular/material/dialog'), require('@angular/material/button'), require('ngx-image-cropper'), require('@angular/material/divider'), require('@angular/material/datepicker'), require('ngx-daterangepicker-material'), require('moment'), require('@angular/material-moment-adapter'), require('ngx-skeleton-loader'), require('@angular/material/progress-bar'), require('@angular/material/radio'), require('@angular/material/select'), require('@angular/material/checkbox'), require('@angular/material/slide-toggle'), require('ngx-mat-select-search'), require('ngx-echarts'), require('@angular/flex-layout'), require('@angular/flex-layout/flex')) :
    typeof define === 'function' && define.amd ? define('@library/tsc-common', ['exports', '@angular/core', 'rxjs', '@angular/common', 'rxjs/operators', '@angular/material/progress-spinner', '@angular/common/http', '@angular/router', '@library/storage-service', '@library/toastr-service', '@library/application-service', '@library/authentication-service', '@angular/forms', '@library/user-service', '@angular/platform-browser', '@angular/material/icon', '@angular/material/tooltip', '@ng-bootstrap/ng-bootstrap', 'ngx-perfect-scrollbar', '@angular-redux/store', '@library/feature-service', '@library/rbac-service', '@angular/material/button-toggle', '@library/layout-service', '@angular/material/card', '@library/organization-service', '@library/facility-service', '@fortawesome/free-solid-svg-icons', '@fortawesome/angular-fontawesome', '@angular/material/core', '@angular/material/input', '@angular/material/form-field', '@ngx-loading-bar/router', '@angular/animations', '@ngx-loading-bar/core', '@fortawesome/free-solid-svg-icons/faArrowAltCircleLeft', '@angular/material/dialog', '@angular/material/button', 'ngx-image-cropper', '@angular/material/divider', '@angular/material/datepicker', 'ngx-daterangepicker-material', 'moment', '@angular/material-moment-adapter', 'ngx-skeleton-loader', '@angular/material/progress-bar', '@angular/material/radio', '@angular/material/select', '@angular/material/checkbox', '@angular/material/slide-toggle', 'ngx-mat-select-search', 'ngx-echarts', '@angular/flex-layout', '@angular/flex-layout/flex'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.library = global.library || {}, global.library["tsc-common"] = {}), global.ng.core, global.rxjs, global.ng.common, global.rxjs.operators, global.ng.material.progressSpinner, global.ng.common.http, global.ng.router, global.i2, global.i2$1, global.i3, global.i5, global.ng.forms, global.i1$3, global.ng.platformBrowser, global.ng.material.icon, global.ng.material.tooltip, global.i5$1, global.i4, global.store, global.i7, global.i8, global.ng.material.buttonToggle, global.i3$1, global.ng.material.card, global.i3$2, global.i4$3, global.freeSolidSvgIcons, global.i1$4, global.ng.material.core, global.ng.material.input, global.ng.material.formField, global.router, global.ng.animations, global.i4$5, global.faArrowAltCircleLeft, global.ng.material.dialog, global.ng.material.button, global.i4$6, global.ng.material.divider, global.ng.material.datepicker, global.i9, global.moment, global.ng.materialMomentAdapter, global.i1$6, global.ng.material.progressBar, global.ng.material.radio, global.ng.material.select, global.ng.material.checkbox, global.ng.material.slideToggle, global.i5$4, global.i1$7, global.ng.flexLayout, global.ng.flexLayout.flex));
})(this, (function (exports, i0, rxjs, i6, operators, i1, i1$1, i1$2, i2, i2$1, i3, i5, i2$2, i1$3, platformBrowser, icon, i6$1, i5$1, i4, store, i7, i8, i5$2, i3$1, i4$1, i3$2, i4$3, freeSolidSvgIcons, i1$4, i4$2, i4$4, i3$3, router, animations, i4$5, faArrowAltCircleLeft, i1$5, i3$4, i4$6, i5$3, i4$7, i9, moment, materialMomentAdapter, i1$6, i3$5, radio, i3$6, checkbox, slideToggle, i5$4, i1$7, flexLayout, i5$5) { 'use strict';
    ...
    var CONNECTION_STATUS_CONSTANT = [
        {
            name: 'Live',
            keyID: 'LIVE'
        },
    ...
    exports.RESPONSE_STATUS_KEYID_ENUM = void 0;
    (function (RESPONSE_STATUS_KEYID_ENUM) {
        RESPONSE_STATUS_KEYID_ENUM["SUCCESS"] = "success";
    })(exports.RESPONSE_STATUS_KEYID_ENUM || (exports.RESPONSE_STATUS_KEYID_ENUM = {}));
    ...
    ***************************************************************************** */
    ...
    var ImageService = /** @class */ (function () {
        function ImageService(userService) {
        ...
        ImageService.prototype.getCountForCircleDisplay = function (value) {
            if (value.length <= 99) {
                var displayCount = value.length - 3;
                return "+" + displayCount;
            }
            else {
                return "+99";
        ...
        ImageService.prototype.getProfileImageUrl = function (user, profileImg) {
    ...
    ImageService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ImageService, deps: [{ token: i1__namespace$3.UserService }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ImageService, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i1__namespace$3.UserService }]; } });
    ...
    var SideNavComponent = /** @class */ (function () {
        ...
        SideNavComponent.prototype.ngOnInit = function () {
            ...
            this.openAccordion();
            if (this.sidebarType == 'LEFT' && !(this.router.url.includes('dashboard') && this.applicationKeyID == i3.ApplicationKeyID.NETZERO_KEY_ID)) {
        ...
        SideNavComponent.prototype.openCurrentActiveRouteMenu = function () {
            var _this = this;
            var currentSideBar = null;
            this.sidebarArray.forEach(function (menu) {
                if (menu === null || menu === void 0 ? void 0 : menu.mainRoute) {
                    menu.mainRoute.forEach(function (route) {
                        if (_this.router.url.includes(route)) {
                            currentSideBar = menu;
                        }
                    });
                    if (currentSideBar != null) {
                        _this.sidebarArray = [currentSideBar];
                        _this.onMenuClick(currentSideBar);
                    }
                }
            });
        };
        ...
        SideNavComponent.prototype.onMenuClick = function (menu) {
            ...
            if (this.sidebarType == 'LEFT') {
                if (menu.dualMenu) {
                    ...
                    var shouldNavigateToDefault_1 = true;
                    if (menu === null || menu === void 0 ? void 0 : menu.mainRoute) {
                        menu.mainRoute.forEach(function (route) {
                            if (_this.router.url.includes(route)) {
                                shouldNavigateToDefault_1 = false;
                            }
                        });
                    }
                    if (shouldNavigateToDefault_1) {
    ...
    var UserDrawerComponent = /** @class */ (function () {
        ...
        UserDrawerComponent.prototype.defaultImage = function (userM) {
            return this.userService.defaultImage(((userM === null || userM === void 0 ? void 0 : userM['firstName']) ? userM['firstName'] + ' ' : '') +
                ((userM === null || userM === void 0 ? void 0 : userM['lastName']) == null ? '' : userM['lastName']), i1$3.ProfileImg.PROFILE_IMAGE_DROPDOWN_NAME_VIEW);
        };
    ...
    UserDrawerComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: UserDrawerComponent, deps: [{ token: 'environment' }, { token: i2__namespace.StorageService }, { token: i1__namespace$3.UserService }, { token: i3__namespace.ApplicationService }, { token: TSCCommonService }], target: i0__namespace.ɵɵFactoryTarget.Component });
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: UserDrawerComponent, decorators: [{
            ...
            return [{ type: undefined, decorators: [{
                            type: i0.Inject,
                            args: ['environment']
                        }] }, { type: i2__namespace.StorageService }, { type: i1__namespace$3.UserService }, { type: i3__namespace.ApplicationService }, { type: TSCCommonService }];
        } });
    ...
    OrgDrawerHeaderModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: OrgDrawerHeaderModule, declarations: [OrgDrawerHeaderComponent], imports: [i5$1.NgbModule,
            platformBrowser.BrowserModule,
            i1$4.FontAwesomeModule], exports: [OrgDrawerHeaderComponent] });
    ...
    BackButtonModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: BackButtonModule, declarations: [BackButtonComponent], imports: [i1$4.FontAwesomeModule], exports: [BackButtonComponent] });
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: DialogOneComponent, decorators: [{
            ...
            return [{ type: i1__namespace$5.MatDialogRef }, { type: undefined, decorators: [{
                            type: i0.Inject,
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ProfileLogoUploadComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i1__namespace$5.MatDialog }, { type: i2__namespace$1.ToastrService }]; }, propDecorators: { roundCropper: [{
                    type: i0.Input
                }], imageInp: [{
                    type: i0.Input
                }], showDeleteBtnInp: [{
    ...
    SkeletonModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: SkeletonModule, declarations: [SkeletonComponent], imports: [i1__namespace$6.NgxSkeletonLoaderModule, i6.CommonModule], exports: [SkeletonComponent] });
    SkeletonModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: SkeletonModule, imports: [[
                i1$6.NgxSkeletonLoaderModule.forRoot(),
                i6.CommonModule
            ]] });
    ...
    BarChartModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: BarChartModule, declarations: [BarChartComponent], imports: [i6.CommonModule, i1__namespace$7.NgxEchartsModule], exports: [BarChartComponent] });
    ...
    ViewComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ViewComponent, deps: [{ token: i2__namespace.StorageService }, { token: i3__namespace.ApplicationService }, { token: i1__namespace$3.UserService }], target: i0__namespace.ɵɵFactoryTarget.Component });
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ViewComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i2__namespace.StorageService }, { type: i3__namespace.ApplicationService }, { type: i1__namespace$3.UserService }]; } });
    ...
    InfoDialogComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: InfoDialogComponent, deps: [{ token: i1$5.MAT_DIALOG_DATA }, { token: i1__namespace$5.MatDialogRef }], target: i0__namespace.ɵɵFactoryTarget.Component });
    InfoDialogComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.2.17", type: InfoDialogComponent, selector: "app-info-dialog", ngImport: i0__namespace, template: "<h6 mat-dialog-title class=\"dialogTitle mb-0\">\n    <div class=\"d-flex align-items-center\">\n        <strong> {{ title }} </strong>\n    </div>\n</h6>\n\n<mat-dialog-content class=\"mat-typography\">\n    <div [innerHTML]=\"body\"></div>\n</mat-dialog-content>\n\n<mat-dialog-actions align=\"end\">\n    <button class=\"button btn btn-secondary px-4\" type=\"button\" mat-dialog-close matRipple\n    [matRippleCentered]=\"MATERIAL_CONSTANT.MAT_RIPPLE_CENTER\">\n        Close\n    </button>\n</mat-dialog-actions>\n", styles: [""], directives: [{ type: i1__namespace$5.MatDialogTitle, selector: "[mat-dialog-title], [matDialogTitle]", inputs: ["id"], exportAs: ["matDialogTitle"] }, { type: i1__namespace$5.MatDialogContent, selector: "[mat-dialog-content], mat-dialog-content, [matDialogContent]" }, { type: i1__namespace$5.MatDialogActions, selector: "[mat-dialog-actions], mat-dialog-actions, [matDialogActions]" }, { type: i1__namespace$5.MatDialogClose, selector: "[mat-dialog-close], [matDialogClose]", inputs: ["type", "mat-dialog-close", "aria-label", "matDialogClose"], exportAs: ["matDialogClose"] }, { type: i4__namespace$1.MatRipple, selector: "[mat-ripple], [matRipple]", inputs: ["matRippleRadius", "matRippleDisabled", "matRippleTrigger", "matRippleColor", "matRippleUnbounded", "matRippleCentered", "matRippleAnimation"], exportAs: ["matRipple"] }] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: InfoDialogComponent, decorators: [{
            ...
            return [{ type: undefined, decorators: [{
                            type: i0.Inject,
                            args: [i1$5.MAT_DIALOG_DATA]
                        }] }, { type: i1__namespace$5.MatDialogRef }];
        } });
    ...
    InfoDialogModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: InfoDialogModule, declarations: [InfoDialogComponent], imports: [i1$5.MatDialogModule,
            i4$2.MatRippleModule] });
    ...
    exports.CONNECTION_STATUS_CONSTANT = CONNECTION_STATUS_CONSTANT;
