...
const ENERGY_RBAC_CONSTANT = {
    ...
    LAYOUT_VIEW_READ: [[ApplicationKeyID.ENERGY_KEY_ID], 'LAYOUT_VIEW', 'BY_DEFAULT_PERMISSION'],
    LAYOUT_ENTITY_TREE_VIEW_READ: [[ApplicationKeyID.ENERGY_KEY_ID], 'LAYOUT_ENTITY_TREE_VIEW', 'BY_DEFAULT_PERMISSION'],
...
const WATER_RBAC_CONSTANT = {
    ...
    CONSUMPTION_BREAKUP_REPORT_READ: [[ApplicationKeyID.WATER_KEY_ID], 'CONSUMPTION_BREAKUP_REPORT', 'BY_DEFAULT_PERMISSION'],
    USAGE_ACROSS_FACILITY_REPORT_READ: [[ApplicationKeyID.WATER_KEY_ID], 'USAGE_ACROSS_FACILITY_REPORT', 'BY_DEFAULT_PERMISSION'],
    WATER_METER_REPORT_READ: [[ApplicationKeyID.WATER_KEY_ID], 'WATER_METER_REPORT', 'BY_DEFAULT_PERMISSION'],
    DERIVED_PARAMETER_REPORT_READ: [[ApplicationKeyID.WATER_KEY_ID], 'DERIVED_PARAMETER_REPORT', 'BY_DEFAULT_PERMISSION'],
    ...
    LAYOUT_VIEW_READ: [[ApplicationKeyID.WATER_KEY_ID], 'LAYOUT_VIEW', 'BY_DEFAULT_PERMISSION'],
    LAYOUT_ENTITY_TREE_VIEW_READ: [[ApplicationKeyID.WATER_KEY_ID], 'LAYOUT_ENTITY_TREE_VIEW', 'BY_DEFAULT_PERMISSION'],
    //BUDGETING AND PLANNING: Setting Sidebar
...
export { ADMIN_RBAC_CONSTANT, ApplicationResourcePermission, CARBON_RBAC_CONSTANT, CONNECT_RBAC_CONSTANT, ENERGY_RBAC_CONSTANT, IsResourcePermission, RBACDirective2, RBACDirectiveModule2, RBACGuard, RBACJson, RBACService, RbacServiceComponent, RbacServiceModule, RbacServiceService, WATER_RBAC_CONSTANT };
