(function (global, factory) {
    ...
    var ENERGY_RBAC_CONSTANT = {
        ...
        DATA_AVAILABILITY_REPORT_READ: [[applicationService.ApplicationKeyID.ENERGY_KEY_ID], 'DATA_AVAILABILITY_REPORT', 'BY_DEFAULT_PERMISSION'],
        ENERGY_USAGE_REPORT_READ: [[applicationService.ApplicationKeyID.ENERGY_KEY_ID], 'ENERGY_USAGE_REPORT', 'BY_DEFAULT_PERMISSION'],
        ENERGY_USAGE_BY_FACILITY_REPORT_READ: [[applicationService.ApplicationKeyID.ENERGY_KEY_ID], 'ENERGY_USAGE_BY_FACILITY_REPORT', 'BY_DEFAULT_PERMISSION'],
        ENERGY_USAGE_BY_SOURCE_REPORT_READ: [[applicationService.ApplicationKeyID.ENERGY_KEY_ID], 'ENERGY_USAGE_BY_SOURCE_REPORT', 'BY_DEFAULT_PERMISSION'],
        ENERGY_USAGE_BY_LOAD_REPORT_READ: [[applicationService.ApplicationKeyID.ENERGY_KEY_ID], 'ENERGY_USAGE_BY_LOAD_REPORT', 'BY_DEFAULT_PERMISSION'],
        ...
        LAYOUT_VIEW_READ: [[applicationService.ApplicationKeyID.ENERGY_KEY_ID], 'LAYOUT_VIEW', 'BY_DEFAULT_PERMISSION'],
        LAYOUT_ENTITY_TREE_VIEW_READ: [[applicationService.ApplicationKeyID.ENERGY_KEY_ID], 'LAYOUT_ENTITY_TREE_VIEW', 'BY_DEFAULT_PERMISSION'],
    ...
    var WATER_RBAC_CONSTANT = {
        ...
        CONSUMPTION_BREAKUP_REPORT_READ: [[applicationService.ApplicationKeyID.WATER_KEY_ID], 'CONSUMPTION_BREAKUP_REPORT', 'BY_DEFAULT_PERMISSION'],
        USAGE_ACROSS_FACILITY_REPORT_READ: [[applicationService.ApplicationKeyID.WATER_KEY_ID], 'USAGE_ACROSS_FACILITY_REPORT', 'BY_DEFAULT_PERMISSION'],
        WATER_METER_REPORT_READ: [[applicationService.ApplicationKeyID.WATER_KEY_ID], 'WATER_METER_REPORT', 'BY_DEFAULT_PERMISSION'],
        DERIVED_PARAMETER_REPORT_READ: [[applicationService.ApplicationKeyID.WATER_KEY_ID], 'DERIVED_PARAMETER_REPORT', 'BY_DEFAULT_PERMISSION'],
        ...
        LAYOUT_VIEW_READ: [[applicationService.ApplicationKeyID.WATER_KEY_ID], 'LAYOUT_VIEW', 'BY_DEFAULT_PERMISSION'],
        LAYOUT_ENTITY_TREE_VIEW_READ: [[applicationService.ApplicationKeyID.WATER_KEY_ID], 'LAYOUT_ENTITY_TREE_VIEW', 'BY_DEFAULT_PERMISSION'],
        //BUDGETING AND PLANNING: Setting Sidebar
