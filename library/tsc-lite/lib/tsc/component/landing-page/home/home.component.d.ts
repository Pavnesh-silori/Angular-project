...
export declare class HomeComponent implements OnInit {
    ...
    deviceInfoM: StatusInfo;
    constructor(storageService: StorageService, dateService: DateService, aggregateDataService: AggregateDataService, entityController: EntityController, deviceController: DeviceController);
    ngOnInit(): void;
