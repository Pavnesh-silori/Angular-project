(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var CreateUpdateComponent = /** @class */ (function () {
        function CreateUpdateComponent(activatedRoute, storageService, entityService, deviceService, unitService, shiftService, userService, tscCommonService, alertRuleFB, toastrService, alertController) {
            var _this = this;
            this.activatedRoute = activatedRoute;
            this.storageService = storageService;
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            _d = this;
                            return [4 /*yield*/, this.deviceService.getDevicesWithEntities(this.orgID, requestBody)];
                        case 1:
