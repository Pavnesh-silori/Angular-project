(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/router'), require('@angular/forms'), require('rxjs'), require('rxjs/operators'), require('@fortawesome/free-solid-svg-icons'), require('@library/tsc-common'), require('@library/storage-service'), require('@library/toastr-service'), require('@angular/common/http'), require('@angular/material/dialog'), require('@fortawesome/angular-fontawesome'), require('@angular/material/table'), require('@angular/material/sort'), require('@angular/material/slide-toggle'), require('@angular/material/paginator'), require('@angular/material/core'), require('@angular/material/tooltip'), require('@ng-bootstrap/ng-bootstrap'), require('@angular/material/icon'), require('@angular/material/button'), require('@angular/material/card'), require('@angular/material/form-field'), require('@angular/material/input'), require('@angular/material/select'), require('@angular/material/checkbox'), require('@angular/material/chips'), require('@angular/material/expansion'), require('@angular/material/radio'), require('ngx-mat-select-search'), require('ngx-perfect-scrollbar'), require('@angular/cdk/keycodes'), require('lodash'), require('@library/user-service'), require('@library/tsc-lite'), require('@angular/flex-layout'), require('@angular/flex-layout/flex'), require('moment-timezone'), require('@library/date'), require('@library/organization-service'), require('@angular/material/datepicker'), require('@angular/material/button-toggle')) :
    typeof define === 'function' && define.amd ? define('@library/alerts', ['exports', '@angular/core', '@angular/common', '@angular/router', '@angular/forms', 'rxjs', 'rxjs/operators', '@fortawesome/free-solid-svg-icons', '@library/tsc-common', '@library/storage-service', '@library/toastr-service', '@angular/common/http', '@angular/material/dialog', '@fortawesome/angular-fontawesome', '@angular/material/table', '@angular/material/sort', '@angular/material/slide-toggle', '@angular/material/paginator', '@angular/material/core', '@angular/material/tooltip', '@ng-bootstrap/ng-bootstrap', '@angular/material/icon', '@angular/material/button', '@angular/material/card', '@angular/material/form-field', '@angular/material/input', '@angular/material/select', '@angular/material/checkbox', '@angular/material/chips', '@angular/material/expansion', '@angular/material/radio', 'ngx-mat-select-search', 'ngx-perfect-scrollbar', '@angular/cdk/keycodes', 'lodash', '@library/user-service', '@library/tsc-lite', '@angular/flex-layout', '@angular/flex-layout/flex', 'moment-timezone', '@library/date', '@library/organization-service', '@angular/material/datepicker', '@angular/material/button-toggle'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.library = global.library || {}, global.library.alerts = {}), global.ng.core, global.ng.common, global.ng.router, global.ng.forms, global.rxjs, global.rxjs.operators, global.freeSolidSvgIcons, global.i7, global.i4, global.i5, global.ng.common.http, global.ng.material.dialog, global.i8, global.ng.material.table, global.ng.material.sort, global.ng.material.slideToggle, global.ng.material.paginator, global.ng.material.core, global.ng.material.tooltip, global.i16, global.ng.material.icon, global.ng.material.button, global.ng.material.card, global.ng.material.formField, global.ng.material.input, global.ng.material.select, global.ng.material.checkbox, global.ng.material.chips, global.ng.material.expansion, global.ng.material.radio, global.i16$1, global.i18, global.ng.cdk.keycodes, global.lodash, global.i7$1, global.i5$1, global.ng.flexLayout, global.ng.flexLayout.flex, global.moment, global.i1$3, global.i3, global.ng.material.datepicker, global.ng.material.buttonToggle));
})(this, (function (exports, i0, i22, i1$1, i2, rxjs, operators, freeSolidSvgIcons, i7, i4, i5, i1, i1$2, i8, i9, i10, i11, i12, i15, i14, i16, i20, i8$1, i9$1, i10$1, i21, i14$1, i12$1, i19, i11$1, i13, i16$1, i18, keycodes, lodash, i7$1, i5$1, flexLayout, i8$2, moment, i1$3, i3, i6, i7$2) { 'use strict';
    ...
    var AlertStatusI = /** @class */ (function () {
        function AlertStatusI() {
        }
        return AlertStatusI;
    }());
    var AlertStatus = /** @class */ (function () {
    ...
    exports.AlertTypeLabelEnum = void 0;
    ...
    })(exports.AlertTypeLabelEnum || (exports.AlertTypeLabelEnum = {}));
    ...
    var AlertRuleController = /** @class */ (function () {
        ...
        AlertRuleController.prototype.getPeriodicAlertType = function (orgID) {
        ...
        AlertRuleController.prototype.getAlertStatusInfo = function (orgID) {
    ...
    var PageComponent = /** @class */ (function () {
        function PageComponent(router, activatedRoute, storageService, toastrService, alertController, escalationController, dialog) {
            ...
            this.AlertTypeLabelEnum = exports.AlertTypeLabelEnum;
        ...
        PageComponent.prototype.ngAfterViewInit = function () {
            ...
            rxjs.merge(this.paginator.page, this.sort.sortChange, rxjs.fromEvent(this.refreshBtn.nativeElement, 'click')).pipe(operators.startWith({}), operators.switchMap(function () {
                ...
                var alertType = _this.alertLabel == exports.AlertTypeLabelEnum.INSTANTANEOUS_LABEL ? exports.AlertTypeEnum.INSTANTANEOUS : exports.AlertTypeEnum.PERIODIC;
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: PageComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i1__namespace$1.Router }, { type: i1__namespace$1.ActivatedRoute }, { type: i4__namespace.StorageService }, { type: i5__namespace.ToastrService }, { type: AlertRuleController }, { type: EscalationController }, { type: i1__namespace$2.MatDialog }]; }, propDecorators: { sort: [{
                    type: i0.ViewChild,
                    args: ['sort']
                }], paginator: [{
                    type: i0.ViewChild,
    ...
    ***************************************************************************** */
    ...
    var CreateUpdateComponent = /** @class */ (function () {
        function CreateUpdateComponent(activatedRoute, alertRuleFB, alertController, 
        // tsc-library
        ...
        // /tsc-library/
            ...
            this.COMMON_CONSTANT = i7.COMMON_CONSTANT;
            this.MATERIAL_CONSTANT = i7.MATERIAL_CONSTANT;
            this.LIST_CONSTANT = i5$1.LIST_CONSTANT;
            this.AlertTypeEnum = exports.AlertTypeEnum;
            this.AlertTypeLabelEnum = exports.AlertTypeLabelEnum;
            this.FormAction = i7.FormAction;
            this.FormErrorEnum = i7.FormErrorEnum;
            this.PageTitleEnum = i7.PageTitleEnum;
            this.ButtonLabelEnum = i7.ButtonLabelEnum;
            this.ProfileImg = i7$1.ProfileImg;
            this.InvalidForm = i7.InvalidForm;
            this.ToastrColor = i5.ToastrColor;
            this.UserContext = i7$1.UserContext;
            ...
            this.userContext = i7$1.UserContext.ROOT_ORG_USER;
            this.inputPlaceholder = "email1@domain.com, email2@domain.com";
            this.periodicAlertType = [new i7.Static()];
            this.conditionConstant = [];
            this.entityM = [new i5$1.ParameterEntity()];
            this.devicesWithEntitiesM = [new i5$1.DevicesWithEntities()];
            this.unitM = [new i5$1.Unit()];
            this.userM = [new i7$1.User()];
            this.rootOrgUserM = [new i7$1.User()];
            this.currentOrgUserM = [new i7$1.User()];
            this.shiftM = [new i5$1.Shift()];
        ...
        CreateUpdateComponent.prototype.ngOnInit = function () {
            var _this = this;
            this.orgID = this.storageService.getStorage('currentOrgID');
            this.conditionConstant = i5$1.LIST_CONSTANT.CONDITION;
            this.activatedRoute.data.subscribe(function (data) {
                _this.alertLabel = data['alertType'];
                if (_this.alertLabel == exports.AlertTypeLabelEnum.PERIODIC_LABEL) {
                    _this.getPeriodicAlertType();
                }
        ...
        CreateUpdateComponent.prototype.getPeriodicAlertType = function () {
            var _this = this;
            this.alertController.getPeriodicAlertType(this.orgID).subscribe(function (res) {
                _this.periodicAlertType = res;
            }, function (error) {
        ...
        CreateUpdateComponent.prototype.alertInit = function () {
            ...
            this.alertRuleFG = this.alertRuleFB.group({
                alertType: [this.alertLabel == exports.AlertTypeLabelEnum.INSTANTANEOUS_LABEL ? exports.AlertTypeEnum.INSTANTANEOUS : exports.AlertTypeEnum.PERIODIC],
                ...
                deviceID: [[]],
                periodicAlertType: [, this.alertLabel == exports.AlertTypeLabelEnum.PERIODIC_LABEL ? i2.Validators.required : []],
                ...
                startValue: [],
                endValue: [],
                userChoice: [i7$1.UserContext.ROOT_ORG_USER],
                ...
                isShift: [, i2.Validators.required],
                shiftID: [[]]
            });
            if (this.alertLabel == exports.AlertTypeLabelEnum.INSTANTANEOUS_LABEL) {
                this.setValidatorsForAlertLevelPref();
                this.setValidatorsForDevice();
            }
            (_a = this.alertRuleFG.get('periodicAlertType')) === null || _a === void 0 ? void 0 : _a.valueChanges.subscribe(function (value) {
                if (value == 'BUDGET') {
                    _this.conditionConstant = i5$1.LIST_CONSTANT.CONDITION.filter(function (condition) { return condition.value != 'BETWEEN'; });
                }
                else {
                    _this.conditionConstant = i5$1.LIST_CONSTANT.CONDITION;
                }
            });
            (_b = this.alertRuleFG.get('isShift')) === null || _b === void 0 ? void 0 : _b.valueChanges.subscribe(function (value) {
                var shiftControl = _this.alertRuleFG.get('shiftID');
                shiftControl === null || shiftControl === void 0 ? void 0 : shiftControl.clearValidators();
                if (value) {
                    _this.addValidation(shiftControl, [i2.Validators.required]);
                }
                else {
                    shiftControl === null || shiftControl === void 0 ? void 0 : shiftControl.clearValidators();
                }
        ...
        CreateUpdateComponent.prototype.addValidation = function (control, validators) {
        ...
        CreateUpdateComponent.prototype.getAlertRuleByID = function () {
            ...
            this.alertController.getAlertRuleByID(this.orgID, this.alertRuleID).subscribe(function (alertRuleRes) {
                ...
                _this.getEntitiesByParameterID(_this.alertRuleM.parameterID);
        ...
        CreateUpdateComponent.prototype.patchAlertFG = function () {
            ...
            this.userFC.patchValue(this.alertRuleM.userChoice == i7$1.UserContext.CURRENT_ORG_USER ? false : true);
        ...
        CreateUpdateComponent.prototype.patchUserFields = function () {
            ...
            if (this.userContext == i7$1.UserContext.ROOT_ORG_USER) {
        ...
        /* entities code */
        CreateUpdateComponent.prototype.getEntitiesByParameterID = function (parameterID) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            _d = this;
                            return [4 /*yield*/, this.entityService.getEntitiesByParameterID(this.orgID, parameterID)];
                        case 1:
                            _d.entityM = (_e.sent());
                            return [2 /*return*/];
                    }
        ...
        CreateUpdateComponent.prototype.setValidatorsForDevice = function () {
            ...
            this.alertRuleFG.get('isAlertAtDeviceLevel').valueChanges.subscribe(function (value) {
                ...
                if (value && _this.alertLabel == exports.AlertTypeLabelEnum.INSTANTANEOUS_LABEL) {
        ...
        CreateUpdateComponent.prototype.getFrequency = function () {
            return this.alertLabel == exports.AlertTypeLabelEnum.INSTANTANEOUS_LABEL
        ...
        CreateUpdateComponent.prototype.userContextChange = function () {
            ...
            if (this.userFC.value) {
                ...
                this.userContext = i7$1.UserContext.CURRENT_ORG_USER;
        ...
        CreateUpdateComponent.prototype.removeSelectedUsers = function (userId) {
            ...
            if (index != -1) {
                ...
                this.selectedUserFC.setValue(this.selectedUserIds);
                this.alertRuleFG.get('userID').setValue(this.selectedUserIds);
                var removedUser = this.userContext == i7$1.UserContext.ROOT_ORG_USER ? this.rootOrgUserM.find(function (user) { return user.id == userId; }) : this.currentOrgUserM.find(function (user) { return user.id == userId; });
                if (removedUser) {
        ...
        CreateUpdateComponent.prototype.getSelectedUsers = function () {
            var _this = this;
            return this.userContext == i7$1.UserContext.ROOT_ORG_USER ? this.rootOrgUserM.filter(function (user) { return _this.selectedUserIds.includes(user.id); }) : this.currentOrgUserM.filter(function (user) { return _this.selectedUserIds.includes(user.id); });
        };
        ...
        CreateUpdateComponent.prototype.createUpdateAlert = function () {
            ...
            if (this.alertRuleFG.invalid) {
                ...
                this.toastrService.openToast(i7.InvalidForm.INVALID_FORM_TITLE, i7.InvalidForm.INVALID_FORM_MESSAGE, i5.ToastrColor.ERROR);
                return;
            }
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: CreateUpdateComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i1__namespace$1.ActivatedRoute }, { type: i2__namespace.FormBuilder }, { type: AlertRuleController }, { type: i4__namespace.StorageService }, { type: i5__namespace$1.EntityService }, { type: i5__namespace$1.EntityDeviceService }, { type: i5__namespace$1.UnitService }, { type: i5__namespace$1.ShiftService }, { type: i5__namespace.ToastrService }, { type: i7__namespace$1.UserService }, { type: i7__namespace.TSCCommonService }]; }, propDecorators: { searchBar: [{
                    type: i0.ViewChild,
                    args: ['searchBar']
    ...
    var CreateUpdateEscalationComponent = /** @class */ (function () {
        function CreateUpdateEscalationComponent(dialogRef, data, escalationFB, escalationController, 
        // tsc-library
        ...
        CreateUpdateEscalationComponent.prototype.patchEscalation = function (escalationLevelConfig) {
            ...
            this.userFC.patchValue(escalationLevelConfig.userChoice == i7$1.UserContext.CURRENT_ORG_USER ? false : true);
        ...
        CreateUpdateEscalationComponent.prototype.createUpdateEscalationRule = function () {
            var _this = this;
            var userID = this.tscCommonService.removeSelectAllID(this.escalationFG.get('userID').value);
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: CreateUpdateEscalationComponent, decorators: [{
            ...
            return [{ type: i1__namespace$2.MatDialogRef }, { type: undefined, decorators: [{
                        ...
                        }] }, { type: i2__namespace.FormBuilder }, { type: EscalationController }, { type: i4__namespace.StorageService }, { type: i5__namespace.ToastrService }, { type: i7__namespace$1.UserService }, { type: i7__namespace.TSCCommonService }];
        } });
    ...
    var ListComponent = /** @class */ (function () {
        function ListComponent(dialog, activatedRoute, escalationController, 
        // tsc-library
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ListComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i1__namespace$2.MatDialog }, { type: i1__namespace$1.ActivatedRoute }, { type: EscalationController }, { type: i4__namespace.StorageService }, { type: i5__namespace.ToastrService }]; } });
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ConfiguredAlarmPageComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i4__namespace.StorageService }, { type: AlertRuleController }]; }, propDecorators: { sort: [{
                    type: i0.ViewChild,
                    args: ['sort']
                }], paginator: [{
                    type: i0.ViewChild,
    ...
    var GeneratedAlarmPageComponent = /** @class */ (function () {
        ...
        GeneratedAlarmPageComponent.prototype.getStatusLabelAndClass = function (status) {
            switch (status) {
                case exports.AlertStatusEnum.ACTIVE:
                    return { label: exports.AlertStatusLabelEnum.ACTIVE_LABEL, class: 'badge rounded-pill bg-warning text-white' };
                case exports.AlertStatusEnum.RESOLVED:
                    return { label: exports.AlertStatusLabelEnum.RESOLVED_LABEL, class: 'badge rounded-pill bg-success' };
                default:
                    return { label: '', class: '' };
            }
        };
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: GeneratedAlarmPageComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i1__namespace$3.DateService }, { type: i4__namespace.StorageService }, { type: i3__namespace.OrganizationService }, { type: AlertRuleController }]; }, propDecorators: { sort: [{
                    type: i0.ViewChild,
                    args: ['sort']
                }], paginator: [{
                    type: i0.ViewChild,
    ...
    */
    ...
    exports.AlertStatusI = AlertStatusI;
