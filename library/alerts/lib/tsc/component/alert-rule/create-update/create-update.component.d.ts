...
import { ParameterComponent, EntityService, EntityTree, DevicesWithEntities, DeviceService, Shift, ShiftService, Unit, UnitService } from '@library/tsc-lite';
...
export declare class CreateUpdateComponent implements OnInit {
    ...
    constructor(activatedRoute: ActivatedRoute, storageService: StorageService, entityService: EntityService, deviceService: DeviceService, unitService: UnitService, shiftService: ShiftService, userService: UserService, tscCommonService: TSCCommonService, alertRuleFB: FormBuilder, toastrService: ToastrService, alertController: AlertRuleController);
    ngOnInit(): void;
